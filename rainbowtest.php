			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-post single-post">
						...
						<h3>《虹彩六號》預告職業電競完整亞太賽事架構 27 日揭露 同步帶來經典表演賽</h3>
						<div class="post-metas">
							<div class="post-meta">By Admin</div>
							<div class="post-meta">in <a href="#">Games</a></div>
							<div class="post-meta">3 Comments</div>
						</div>
						<p>Ubisoft 今（26）日預告將於明（27）日的直播節目中揭露《虹彩六號》亞太聯賽最新消息，其中包含《虹彩六號》經典賽等。　Ubisoft 預定於明日的直播節目中揭露《虹彩六號》詳細亞太聯賽消息，今日搶先透露將舉辦《虹彩六號》史無前例的《虹彩六號》經典賽，屆時將重現《虹彩六號》職業聯賽史上令人難忘的比賽或對戰。另外，為了替 4 年來激烈競爭的《虹彩六號》職業聯賽劃下句點，並慶祝亞太地區邁入新的《虹彩六號》電競時代，來自亞太地區的著名職業戰隊將再次接受挑戰，與昔日的對手展開對決；職業選手將進行線上對戰，並採用一些歷史比賽設定，例如和原比賽一模一樣的特勤幹員清單。
 
                            　　官方表示，第 1 場比賽將由 FNATIC Classics 出戰 Nora-Rengo Classics。這兩支來自亞太地區的著名戰隊將重現雙方隊伍在 2019 SIX 國際邀請賽和職業聯賽第九賽季總決賽的八強賽中各勝一場的激烈對決。第 2 場比賽由 Aerowolf Classics 出戰 Wildcard Gaming Classics，將重現職業聯賽第十賽季中令人印象深刻的亞太地區總冠軍賽。
                             
                            　　另外，在明日登場的直播中，玩家可以捐款給無國界醫生組織（Médecins Sans Frontières/Doctors Without Borders ），直播期間還可以參加 Twitch Drops 活動，本次 Twitch Drops 包含《圍攻行動》職業聯賽飾品，並在 3 日內送出。</p>
                            <div class="youtube-embed-wrapper" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden"><iframe allowfullscreen frameborder="0" height="360" src="https://www.youtube.com/embed/MtYgaJ3vN8A" style="position:absolute;top:0;left:0;width:100%;height:100%" width="640" loading="lazy"></iframe></div>
                            
							<?php 
								include("conn_comment.php");
								$sql = "SELECT * FROM `comment` WHERE `Class`='rainbowtest' ORDER BY `Time` DESC ";
							...
							<form class="comment-form" action="leave_comment.php" method="post">
								<div class="row">
									<div class="col-md-8">
										...
										<input name="gametitle" type="hidden" value="rainbowtest">
									</div>
									<div class="col-md-12">
