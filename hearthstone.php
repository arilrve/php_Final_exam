			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-post single-post">
						...
						<h3>戰況白熱化《爐石戰記》大師職業賽例行賽倒數第二週　Shaxy、Tom 明晚關鍵對戰</h3>
						<div class="post-metas">
							<div class="post-meta">By Admin</div>
							<div class="post-meta">in <a href="#">Games</a></div>
							<div class="post-meta">3 Comments</div>
						</div>
						<p>《爐石戰記》大師職業賽亞太區第一賽季例行賽將於明（21）日進入第三週，目前賽事進入白熱化階段，而明日晚上 8 時將上演台灣內戰，由 Shaxy 對上 tom60229，對兩位選手來說這場比賽都是關鍵之戰。
 
                            　　在經過兩週的賽事後，《爐石戰記》大師職業賽亞太區第一賽季例行賽將於明日迎來倒數第二週賽程。Blizzard 表示目前賽事十分膠著，任何一場對戰勝負都可能影響排名和決定選手在大師職業賽的去留，而面對即將結束的小組循環賽，選手將在未來兩週全力奮戰，爭奪晉級季後賽和避免降級命運。
                             
                            　　在台灣選手方面，選手 Shaxy 和 tom60229 將於明日晚間 8 時展開台灣內戰，兩位目前排名都位於分組 B 前四，面對勢必分出勝負的對戰，兩位選手也只能兄弟爬山各自努力，盡力爭取勝場。而另一位台灣選手 SamuelTsao 目前排名位於Ｂ組第七，將於本週六、日分別對上 FroStee 和 DawN，處在不能輸的壓力，SamuelTsao 勢必要奮力一搏。</p>
                            <img src="img/blog/photo1.jpg" alt="">
                           <p>此外，即日起至 5 月 27 日止，暴雪商店限時推出「黃金卡牌禮盒」（售價為新台幣 $450 元），內含六包全部為金卡的經典卡牌包，喜愛收集特殊金卡的玩家敬請把握機會納入收藏！而上週開放免費限時領取的爐邊聚會特殊獎勵 – 術士英雄奈姆希頭像將延長領取至 5 月 26 日止，玩家僅需登入遊戲並至商店頁面即可將可愛的奈姆希納入收藏。</p>
                           <div class="youtube-embed-wrapper" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden"><iframe allowfullscreen frameborder="0" height="360" src="https://www.youtube.com/embed/uwTmzO5Ezo8" style="position:absolute;top:0;left:0;width:100%;height:100%" width="640" loading="lazy"></iframe></div>
							<?php 
								include("conn_comment.php");
								$sql = "SELECT * FROM `Comment` WHERE `Class`='heartstone' ORDER BY `Time` DESC ";
							...
							<form class="comment-form" action="leave_comment.php" method="post">
								<div class="row">
									<div class="col-md-8">
										...
										<input name="gametitle" type="hidden" value="heartstone">
									</div>
									<div class="col-md-12">
