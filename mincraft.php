			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-post single-post">
						<img src="img/blog/mincraft1.jpg" alt="">
                        ...
                        <img src="img/blog/mincraft2.jpg" alt="">
                        <p>《我的世界：地下城》的視覺表現就跟《我的世界》如出一轍，不過由 “迷宮探險” 所發想出的玩法，卻並非像是 RPG 般讓角色成長，而是讓玩家扮演找尋寶物的一位尋寶者，與同伴們一起進行迷宮探索。採用了斜上俯瞰視角，帶有華麗特效的戰鬥也是其特色之一。</p>
                        <img src="img/blog/mincraft3.jpg" alt="">
                        <div class="youtube-embed-wrapper" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden"><iframe allowfullscreen frameborder="0" height="360" src="https://www.youtube.com/embed/ZMKODnLC_o4" style="position:absolute;top:0;left:0;width:100%;height:100%" width="640" loading="lazy"></iframe></div>
							<?php 
								include("conn_Comment.php");
								$sql = "SELECT * FROM `comment` WHERE `Class`='minecraft' ORDER BY `Time` DESC ";
							...
							<form class="comment-form" action="leave_comment.php" method="post">
								<div class="row">
									<div class="col-md-8">
										...
										<input name="gametitle" type="hidden" value="minecraft">
									</div>
									<div class="col-md-12">
