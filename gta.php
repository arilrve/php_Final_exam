			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-post single-post">
						...
						<p>《俠盜獵車手V》（英語：Grand Theft Auto V）是一款開放世界動作冒險遊戲，由Rockstar North製作，Rockstar Games發行。本作在2013年9月17日於PlayStation 3和Xbox 360主機上推出。這是《俠盜獵車手》系列中第15款作品，也是繼2008年的《俠盜獵車手IV》後第一款本傳的續作。由於本作是第七世代遊戲機末期推出的大型作品之一，因此在上市前便獲得了廣大的期待。

                            《俠盜獵車手V》是在開放世界環境中以第三人稱、第一人稱遊玩，可讓玩者自由的與遊戲世界互動。遊戲背景設定在虛構的美國聖安地列斯州（San Andreas，以南加州為範本），玩者可隨意地在荒漠間和虛構的城市洛聖都（Los Santos，以洛杉磯為範本）中漫遊。本作故事模式中有三位主角，玩者可在三人之間自由切換操控，而故事劇情則以三人策劃並執行六次大型搶劫行動。遊戲中也包含了線上多人模式，名為俠盜獵車手Online，已於同年10月1日開放，最多可容納30位玩家（PS4,Xbox One及PC版最多可容納30位玩家）在遊戲世界中互相競爭或合作。
                            
                            開發商將《俠盜獵車手V》視為能延續該公司過往多款作品精神的遊戲，例如《碧血狂殺》和《江湖本色3》。本作的開發在《俠盜獵車手IV》推出後隨即展開，主要著重在系列遊戲核心架構上的創新，提供三名主角讓玩者操控。《俠盜獵車手V》一推出就獲得許多評論的讚賞，特別是針對遊戲的故事劇情、表現手法和開放自由的遊玩方式。《俠盜獵車手V》也在商業上獲得極大成功，上市後24小時之內就創下突破遊戲業界紀錄的8億美金銷售額，三天內總銷售額達到10億美元，成為歷史上銷售速度最快的娛樂性產品。
                            
                            在次世代方面，Rockstar Games曾暗示將發布至其他最新平台，並於2014年索尼的E3遊戲展前發布會上宣布本作將在2014年秋季登陸PlayStation 4遊戲平台；並在稍後公布了也將同步登陸Xbox One，最後將是集結所有技術的PC版本，但也因為在新平台開發，電腦版隨著主機因素一同順延後又因為技術問題二度跳票，遊戲上市比起前一部作品慢了一年之久。</p>
						<?php 
							include("conn_comment.php");
							$sql = "SELECT * FROM `Comment` WHERE `Class`='gta' ORDER BY `Time` DESC ";
							...
							<form class="comment-form" action="leave_comment.php" method="post">
								<div class="row">
									<div class="col-md-8">
                                        ...
                                        <input name="gametitle" type="hidden" value="gta">
									</div>
									<div class="col-md-12">
