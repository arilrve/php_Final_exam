			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-post single-post">
						<img src="img/blog/switch.jpg" alt="">
						<div class="post-date">May 24, 2020</div>
						<h3>為什麼玩單機遊戲也會被 BAN 帳號？你或許不知道的超危險網購陷阱</h3>
                        ...
                        <p>隨著近期 Switch 主機的熱賣，一個存在已久、但卻依然有許多人掉以輕心的詐騙陷阱也逐漸猖獗了起來，本週巴哈姆特電玩瘋的特別企劃就要來告訴大家，「為什麼玩單機遊戲也會被 BAN 帳號？你或許不知道的超危險網購陷阱」。</p>
                            ...
                            <div class="youtube-embed-wrapper" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden"><iframe allowfullscreen frameborder="0" height="360" src="https://www.youtube.com/embed/9mwJsnu4qzI" style="position:absolute;top:0;left:0;width:100%;height:100%" width="640" loading="lazy"></iframe></div>
                            
                            <?php 
								include("conn_Comment.php");
								$sql = "SELECT * FROM `comment` WHERE `Class`='tv' ORDER BY `Time` DESC ";
							...
							<form class="comment-form" action="leave_comment.php" method="post">
								<div class="row">
									<div class="col-md-8">
                                        ...
                                        <input name="gametitle" type="hidden" value="tv">
									</div>
									<div class="col-md-12">
