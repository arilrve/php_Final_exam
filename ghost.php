			...
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-post single-post">
						<img src="img/blog/ghostot.jpg" alt="">
						<div class="post-date">May 25, 2020</div>
						<h3>《對馬幽魂》2020夏天開賣，全新宣傳影片「戰鬼」亮相</h3>
						<div class="post-metas">
							<div class="post-meta">By Admin</div>
							<div class="post-meta">in <a href="#">Games</a></div>
							<div class="post-meta">3 Comments</div>
                        </div>
						<p>《對馬幽魂》（Ghost of Tsushima）今（13）日一大早在 TGA 遊戲大賞確認將在 2020 年夏天推出，同步釋出約 4 分鐘的最新宣傳影片「戰鬼」（The Ghost）。

 

                            前幾天如果有關注「State of Play」想必對這隻影片有點印象，是的！前半段是同一隻，但是這次在 TGA 頒獎典禮公開了後半段；更讓人知道原來遊戲中的「The Ghost」名稱就是「境井仁」。
                            
                             
                            
                            儘管這次依舊沒有透露更多的遊戲玩法，但是《對馬幽魂》一如過往給人的映像，帶來如電影般美輪美奐的遊戲場景。
                            
                             
                            
                            《對馬幽魂》現已確定在 2020 年夏天推出，平台未定。 </p>
                            <img src="img/blog/ghost1.jpg " alt="">
                            <div class="youtube-embed-wrapper" style="position:relative;padding-bottom:56.25%;padding-top:30px;height:0;overflow:hidden"><iframe allowfullscreen frameborder="0" height="360" src="https://www.youtube.com/embed/RDzgNs-zfng" style="position:absolute;top:0;left:0;width:100%;height:100%" width="640" loading="lazy"></iframe></div>
						
							<?php 
								include("conn_Comment.php");
								$sql = "SELECT * FROM `comment` WHERE `Class`='ghost' ORDER BY `Time` DESC ";
							...
							<form class="comment-form" action="leave_comment.php" method="post">
								<div class="row">
									<div class="col-md-8">
										...
										<input name="gametitle" type="hidden" value="ghost">
									</div>
									<div class="col-md-12">
